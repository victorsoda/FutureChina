...
<div class="footer" <?php echo $footer_bs;?>>
 ...
 <div id="footer_in_box" class="footer_in_box footer_linkss">
   ...
   <div  id="footer_bottom_link" class="footer_in">
        <?php  wp_nav_menu(array( 'theme_location'  => "footer-menu" ,'menu_class'=> 'footer_bottom_link','container' => false  ) ); ?>
      
     
     <p class="f_bq id="tttttttt""> <?php  if($word_t2!=""){echo $word_t2;}else{echo '版权所有';}  ?> &copy;<?php echo date("Y"); echo " "; bloginfo('name'); 
		    echo ' |   <a rel="nofollow" target="_blank" href="http://www.miitbeian.gov.cn/">蜀ICP备17025138号</a>'; ;	   
			echo ' |  <a class="banquan" target="_blank" href="http://www.miitbeian.gov.cn/">蜀ICP备17025138号-1</a>';		  
 ...
 <div class="footer_bottom" <?php echo $footer_ds;?>>
  ...
  <div class="footer_in">
   ...
   <?php  wp_nav_menu(array( 'theme_location'  => "link-menu2" ,'menu_class'=> 'footer_bottom_link','container' => false  ) ); ?>
   </div>
</div>
	...
	<?php  
get_template_part( 'kefu' ); wp_footer(); echo '<!-- 总共'.get_num_queries() . '次查询，耗时' . timer_stop(0) . '秒.-->';?>
