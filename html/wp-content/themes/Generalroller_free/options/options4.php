...
<b class="bt">翻译</b><br />
 <p>对照左边的中文，你可以吧这些固定的词语替换成你想要的，如果你不是多语言网站，也可以使用这个功能改变你想要改变的文字。</p>
      ...
      <p> <label  for="word_t54">查看详细介绍（魔术菜单按钮）：</label> 
     <input type="text" size="20"  name="word_t54" id="word_t54" value="<?php if($word_t54!=""){echo $word_t54;}else{echo '查看详细介绍';}  ?>"/  />        
   </p>  
   
     <p> <label  for="word_t55">查看详细说明（案例模块按钮）：</label> 
     <input type="text" size="20"  name="word_t55" id="word_t55" value="<?php if($word_t54!=""){echo $word_t55;}else{echo '查看详细说明';}  ?>"/  />        
   </p>  
     
      <p> <label  for="word_t53">导航菜单（新闻模块）：</label> 
     <input type="text" size="20"  name="word_t53" id="word_t53" value="<?php if($word_t53!=""){echo $word_t53;}else{echo '查看所有';}  ?>"/  />        
   </p>  
