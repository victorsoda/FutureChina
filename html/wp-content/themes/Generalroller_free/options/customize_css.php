	 ...
	 <?php 
				 ...
				 if( $mytheme_nav_hover&&$mytheme_nav_hover!='#fafafa'){echo '#header_pic_nav li:hover, #header_pic_nav li.current-menu-item{ background:'.$mytheme_nav_hover.';}';}
				  ...
				  if( $mytheme_nav_title2&&$mytheme_nav_title2!='#ffa800'){echo '#header_pic_nav li p{ color: '.$mytheme_nav_title2.';}';}
				   ...
				   if( $mytheme_top_title&&$mytheme_top_title!='#ffa800'){echo '.header_bottom_in a,language_drop a{ color: '.$mytheme_top_title.';}';}
				   
				    if( $index_blue&&$index_blue!='#f50028'){echo '.mantitle, .mantitle a,.about_btn a,.cunster_container .swiper-slide a div{ color: '.$index_blue.';}.about_btn a{border: 1px solid '.$index_blue.';}.about_btn a:hover,.about_ttile_line .about_title_line_in{background:'.$index_blue.'}';}
